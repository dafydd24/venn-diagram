...
def draw_text(fig, ax, x, y, text, color=[0, 0, 0, 1], fontsize=10, ha="center", va="center"):
    ax.text(
        x, y, text,
...
def get_labels(data, fill=["string"]):
    """
    ...
    input
      ...
      fill: ["number"|"logic"|"percent"|"string"]
